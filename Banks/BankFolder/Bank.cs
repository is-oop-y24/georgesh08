...
namespace Banks.BankFolder
{
    public class Bank
    {
        ...
        public void OpenNewCreditAccount(Client client, BankCreditAccount account, double moneyAmount)
        {
            if (IsSuspicious(client))
            {
                throw new AccountException(
                    "Client must enter his passport and address info before creating an account.");
            }
        ...
        public void AddNewAccountType(IBankAccount newAccount)
        {
        ...
        private bool IsSuspicious(Client client)
        {
